...
def create_executive_html_report(data, analysis_results, product_manager=None, recipient_name=None):
    ...
    All text is CENTER-ALIGNED except the Optum logo.
...
<head>
    ...
    <style>
        ...
        /* CENTER-ALIGNED dashboard section */
        .dashboard-wrapper {{
                ...
                <div class="peach-header">
                    <div class="peach-content">
                        ...
                        <div class="peach-right">
                            <!-- Circular image placeholder (centered) -->
                ...
                <div class="dashboard-wrapper">
                    <div class="dashboard-section">
                        ...
                        <div class="dashboard-preview">
                            <!-- CENTER-ALIGNED dashboard preview image -->
...
if __name__ == "__main__":
    print("Rally Email Template - CENTER-ALIGNED VERSION")
    print("=" * 50)
    print("\nAlignment:")
    print("  Optum logo: LEFT-ALIGNED")
    print("  All other text: CENTER-ALIGNED")
    print("\nPadding: 100px left/right on all sections")
